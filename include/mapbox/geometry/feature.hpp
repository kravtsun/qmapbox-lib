...
{
    null_value_t() {}
    null_value_t(std::nullptr_t) {}
};

bool operator==(const null_value_t&, const null_value_t&) { return true; }
bool operator!=(const null_value_t&, const null_value_t&) { return false; }
bool operator<(const null_value_t&, const null_value_t&) { return false; }

null_value_t null_value = null_value_t();
...
{
//    using typename value_base::value_base;
};
