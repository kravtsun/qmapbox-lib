...
using index_sequence = boost::context::detail::index_sequence<I...>;
...
public:
    ...
    void operator()() override {
        ...
        if (!*canceled) {
            invoke(boost::context::detail::make_index_sequence<std::tuple_size<P>::value>{});
        }
    }
...
-> decltype(std::make_tuple(std::get<Indexes>(std::forward<Tuple>(args))...))
{
